...
func (s *UserStore) ListStores(ctx context.Context) ([]models.User, error) {
...
func (s *UserStore) GetByIDStore(ctx context.Context, id int64) (*models.User, error) {
...
func (s *UserStore) GetByEmailStore(ctx context.Context, email string) (*models.User, error) {
...
func (s *UserStore) GetByPhoneStore(ctx context.Context, phone string) (*models.User, error) {
...
func (s *UserStore) GetCountStore(ctx context.Context) (int64, error) {
...
func (s *UserStore) InsertStore(ctx context.Context, arg models.User) (*models.User, error) {
	queryStmt := `
	INSERT INTO
	users(
		code,
...
func (s *UserStore) UpdateUser(ctx context.Context, tx *sql.Tx, arg models.User) error {
	queryStmnt := `
	Update users 
	SET
		first_name=$1,
